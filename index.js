...
//document will give access to Dom and methods for modifying
...
<div class="card">
  ...
  <div class="card-footer">
    <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#newOpenTask" name=${taskData.id}>Open Task</button>
  </div>
</div>
</div>`;
};
...
const saveEdit = (event) => {
  ...
  const updateData = {
    ...
    type : taskType.innerHTM, 
    description : taskDescription.innerHTM,
  };
...
const openTask = () => {
  const newTask = generateHTML(taskData);
};
//Stringify 